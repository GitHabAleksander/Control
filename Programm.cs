int count_three_symbols(string[] arr_str) {
    int count = 0;
...
string[] arr_max_three_symbols(string[] arr_str) {
    int size = count_three_symbols(arr_str);
    int index = 0;
...
{
    int size = 0;
    Console.WriteLine("Количество элементов в массиве(ENG):");
    Console.WriteLine("Для завершения введи - 0");
